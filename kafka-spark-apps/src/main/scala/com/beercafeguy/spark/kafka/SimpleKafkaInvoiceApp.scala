...
import com.beercafeguy.spark.commons.BeerCafeStreamingSessionBuilder
...
object SimpleKafkaInvoiceApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val valueDF = invoiceStream.select(from_json(col("value").cast("string"), getSchema()).alias("value"))

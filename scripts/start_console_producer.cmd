...
REM %KAFKA_HOME%\bin\windows\kafka-console-producer.bat --broker-list localhost:9093 --topic logins
%KAFKA_HOME%\bin\windows\kafka-console-producer.bat --broker-list localhost:9093 --topic rates